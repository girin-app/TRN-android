...
class SubmittableExtrinsicTest {
    ...
    fun testSubmittableExtrinsicWithMethodWithdrawXrp() {
        ...
        val signature =
            FastHex.decode("b25593b528be5d02feca601b9c71416f7d32eddbd89a4e5ba4e0c20931f4993852d786d5ff70615218ede9ee1605692bca3311d89a1d55a9c88f7d0f9978bfd400")
        ...
        Assert.assertEquals(
            "",
            extrinsic.toHex()
        )
    }
    ...
    fun testSign() {
        ...
        val signer =
            PrivateKeySigner("0xf28c395640d7cf3a8b415d12f741a0299b34cb0c7af7d2ba6440d9f2d3880d65")

        extrinsic.sign(signer, runtimeVersion, genesisHash, blockHash)
        Assert.assertEquals(
            "b25593b528be5d02feca601b9c71416f7d32eddbd89a4e5ba4e0c20931f4993852d786d5ff70615218ede9ee1605692bca3311d89a1d55a9c88f7d0f9978bfd41b",
            extrinsic.signature.signature!!.toByteString().hex()
        )
        Assert.assertEquals(
            "0x55D77A60Fd951117f531D2277a5BB4aFbE3fB292",
            extrinsic.signature.signer!!.toChecksumString()
        )
    }
    ...
    fun testPayload() {
        ...
        Assert.assertEquals(
            "120340420f0000000000000000000000000072ee785458b89d5ec64bec8410c958602e6f76731603d000360000000900000083959f7f4262762f7599c2fa48b418b7e102f92c81fab9e6ef22ab379abdb72f229c525b91f1b6b29c56d57697ba8df4bf4fa6d15aee295e0d611a85f53dde31",
            payload.toByteString().hex()
        )
    }
}